...
public class BasicCrawlController {
    ...
    private final static int numberOfCrawlers = 6;
    private final static String crawlSeed = "https://www.reuters.com/";
    private final static int maxPageToFetch = 20000;
    private final static int maxDepthOfCrawling = 16;
    private final static String name = "Mukund Murrali";
    private final static String id = "1264824477";
    private final static String newssite = "reuters.com";
    ...
    public static void saveFetchCsv(CrawlState sumState) throws Exception {
        String fileName = crawlStorageFolder + "/fetch_reuters.csv";
    ...
    public static void saveVisitCsv(CrawlState sumState) throws Exception {
        String fileName = crawlStorageFolder + "/visit_reuters.csv";
        FileWriter writer = new FileWriter(fileName);
        writer.append("URL,Size,OutLinks,ContentType\n");
        for (UrlInfo info : sumState.visitedUrls) {
            if (info.type != "unknown") {
                writer.append(info.url + "," + info.size + "," + info.outgoingUrls + "," + info.type + "\n");
            }
        }
        writer.flush();
        writer.close();
    ...
    public static void saveUrlsCsv(CrawlState sumState) throws Exception {
        String fileName = crawlStorageFolder + "/urls_reuters.csv";
        FileWriter writer = new FileWriter(fileName);
    ...
    public static void saveStatistics(CrawlState sumState) throws Exception {
    	...
    	public static CrawlController runCrawler() throws Exception {
            ...
            config.setUserAgentString("mukundmurrali");
